# Kadamba Residency — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-kadamba-residency/
- **Repo:** `shreekantha3/sindagi-kadamba-residency` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-kadamba-residency/'` for GitHub Pages project-site hosting.
