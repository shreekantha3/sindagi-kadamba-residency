# TEST REPORT — Kadamba Residency
> Tester: Senior Engg | Segment: Hotel | Tier-3
...
- Maps URL + JSON-LD Hotel schema + H1 with business name
- No lorem ipsum, no invented hours/prices/ratings

## Build result (2026-09-15)
- [x] `npm run build` PASS (vite 5.4.21, 0 warnings)
- dist: index 12.65 kB / CSS 11.59 kB / JS 1.17 kB — under perf budget (<200KB JS, <1.5MB total)
